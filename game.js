...
function gameDraw() {
  ...
  if (pausegame) {
    ...
    textAlign(CENTER, CENTER);
    noStroke();
    text("RECUERDA QUE NO SE GUARDARA TU PUNTAJE!", width / 2, height - height / 3 + 15);
...
function operationMatrix(diff) {
  ...
  switch(level) {
    ...
    case 2: 
      switch(diff) {
        case 1:
          first = int(random(1, 12)) * 2; // 2-24
          last = int(random(1, 12)) * 2; // 2-24
